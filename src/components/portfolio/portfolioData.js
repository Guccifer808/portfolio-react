...
const PortfolioData = [
  ...
  },
  {
    ...
    modalDetails: [
      {
        project: 'Velo.js & WIX CMS Project',
        client: 'Manhattan Global Partners',
        techStack: 'Velo.js, Chart.js, WIX CMS, CSS',
        preview: 'Website Link',
        link: 'https://www.manhattanglobal.partners/',
      },
    ],
  },
  {
  ...
  {
    id: 17,
    type: 'Zaid Khan Personal Website',
    image: Image18,
    delayAnimation: '0',
    modalDetails: [
      {
        project: 'Investment Portfolio Website Project',
        client: 'Zaid Khan Personal Website',
