    ...
    <ul className='row grid'>
      ...
      <li className='direction-reveal'>
        <figure className='direction-reveal__card' onClick={toggleModalFour}>
          <img src='img/projects/fitness-ts-1.webp' alt='fitness-portfolio' />
          <div className='direction-reveal__overlay direction-reveal__anim--enter'>
            <span className='direction-reveal__title'>Fitness Landing SPA</span>
          </div>
        </figure>
      ...
      <li className='direction-reveal'>
        <figure className='direction-reveal__card' onClick={toggleModalSix}>
          ...
          <div className=' direction-reveal__overlay direction-reveal__anim--enter'>
            <span className='direction-reveal__title'>Airbnb Clone</span>
          </div>
        </figure>
      ...
      <li className='direction-reveal'>
        <figure className='direction-reveal__card' onClick={toggleModalEight}>
          <img src='img/projects/ecom-mern.webp' alt='ecom-mern-portolio' />
          <div className='direction-reveal__overlay direction-reveal__anim--enter'>
            <span className='direction-reveal__title'> Ecommerce MERN</span>
          </div>
      ...
      <li className='direction-reveal'>
        <figure className='direction-reveal__card' onClick={toggleModalNine}>
          <img src='img/projects/kanban-2.webp' alt='kanban-ts-portolio' />
          <div className='direction-reveal__overlay direction-reveal__anim--enter'>
            <span className='direction-reveal__title'> Kanban TypeScript</span>
          </div>
        </figure>
